...
// inf. https://golangbyexample.com/channel-golang/
// "ready <-chan int" is to only read from channel(e.g. val := <- ready)
// "ready chan<- int" is to only write to channel(e.g. ready <- val)
